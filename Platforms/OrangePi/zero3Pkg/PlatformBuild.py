##
# Script to Build OrangePi Zero3 UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("zero3Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('zero3', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "zero3", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "zero3Pkg/zero3.dsc", "Platform Hardcoded")
